...
var userPosition = surnameList.indexOf(userSurname);

//print della userPosition
document.getElementById('position').innerText = 'il tuo cognome è nella posizione numero: ' + (userPosition + 1) + ' della lista';
